...
const Footer = () => {
  return (
    <footer className="relative mt-32">
        <div className="absolute inset-0 h-20 bg-bottom bg-no-repeat bg-cover -top-20 bg-[url(/footer-b.png)]" ></div>
        <div className="px-4 divide-y">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			
				
            <Link href="/" className="flex -ml-6 justify-center space-x-3 lg:justify-start">
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2024 house8up Co. All rights reserved.</div>
</div>
    </footer>
