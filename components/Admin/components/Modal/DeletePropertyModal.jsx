import { deleteBrokerProperty, deleteProperty } from "@/app/api/postApi/properties";
import React from "react";
import { toast } from "sonner";

const DeletePropertyModal = ({ propertyId, setShowDeleteModal, broker,onDelete }) => {
  const handleDelete = async () => {
   try {
    if( broker){
      await deleteBrokerProperty(propertyId);
    }else{
