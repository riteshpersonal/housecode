"use client"
import { addBrokerProperty } from '@/app/api/postApi/properties';
...
const AddPropertyForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addBrokerProperty({ ...formData, images: uploadedImageUrls,  address: {
    ...
    <form onSubmit={handleSubmit}>
      <div className="grid grid-cols-6 gap-6">
        ...
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="title" className="block mb-2 text-sm font-medium text-gray-900">Property Title</label>
          <input 
            type="text" 
            name="title" 
            id="title" 
        ...
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="bhk" className="block mb-2 text-sm font-medium text-gray-900">BHK</label>
          <input 
            type="text" 
            name="bhk" 
            id="bhk" 
        ...
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="zipCode" className="block mb-2 text-sm font-medium text-gray-900">ZipCode</label>
          <input 
            type="text" 
            name="zipCode" 
            id="zipCode" 
        ...
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="listingPrice" className="block mb-2 text-sm font-medium text-gray-900">Listing Price</label>
          <input 
            type="text" 
            name="listingPrice" 
            id="listingPrice" 
        ...
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="depositAmount" className="block mb-2 text-sm font-medium text-gray-900">Deposit Amount</label>
          <input 
            type="text" 
            name="depositAmount" 
            id="depositAmount" 
        ...
        <div className="col-span-6 sm:col-span-3">
          <label htmlFor="furnishingStatus" className="block mb-2 text-sm font-medium text-gray-900">Furnishing Status</label>
          <select 
        ...
        <div className="col-span-6 sm:col-span-3">
              <label htmlFor="videoTourLink" className="block mb-2 text-sm font-medium text-gray-900 ">Video Tour Link</label>
              <input 
                type="text" 
                name="videoTourLink" 
                id="videoTourLink" 
            ...
            <div className="col-span-6 sm:col-span-3">
              <label htmlFor="ownerAuthorization" className="block mb-2 text-sm font-medium text-gray-900 ">Owner Authorization</label>
              <input 
                type="checkbox" 
            ...
            <div className="col-span-6 sm:col-span-6">
              <label htmlFor="legalDisclosures" className="block mb-2 text-sm font-medium text-gray-900 ">Legal Disclosures</label>
              <textarea 
            ...
            <div className="col-span-6 sm:col-span-6">
              <label htmlFor="specialNotes" className="block mb-2 text-sm font-medium text-gray-900 ">Special Notes</label>
              <textarea 
                name="specialNotes" 
                id="specialNotes" 
